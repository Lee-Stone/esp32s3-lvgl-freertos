...
static float lv_100ask_calc_expr(lv_obj_t *obj);
static float lv_100ask_calc_term(lv_obj_t *obj);
static float lv_100ask_calc_factor(lv_obj_t *obj);
static float lv_100ask_calc_tokenizer_num(char *curr_char);
static void lv_100ask_calc_accept(lv_obj_t *obj, token_t token);
static void lv_100ask_calc_error(error_t_copy error_code ,error_t_copy err);
