...
void Map5_Init()
{
  ...
  InfoNES_Reset( Map5_Wram, 0x00, sizeof( Map5_Wram ) );
  InfoNES_Reset( Map5_Ex_Ram, 0x00, sizeof( Map5_Ex_Ram ) );
  InfoNES_Reset( Map5_Ex_Vram, 0x00, sizeof( Map5_Ex_Vram ) );
  InfoNES_Reset( Map5_Ex_Nam, 0x00, sizeof( Map5_Ex_Nam ) );
...
void Map5_Apu( WORD wAddr, BYTE byData )
{
  ...
  switch ( wAddr )
  {
    ...
    case 0x5106:
      InfoNES_Reset( Map5_Ex_Nam, byData, 0x3c0 );
      break;

    case 0x5107:
      byData &= 0x03;
      byData = byData | ( byData << 2 ) | ( byData << 4 ) | ( byData << 6 );
      InfoNES_Reset( &( Map5_Ex_Nam[ 0x3c0 ] ), byData, 0x400 - 0x3c0 );
      break;
